...
def raw_probability(red_wins, black_wins, purple_wins, green_wins, yellow_wins, white_wins, orange_wins, gold_wins):
    ...
    raw_black = black(rounds, black_wins)
    raw_red = red(rounds, red_wins)
    raw_purple = purple(rounds, purple_wins)
    raw_green = green(rounds, green_wins)
    raw_yellow = yellow(rounds, yellow_wins)
    raw_white = white(rounds, white_wins)
    raw_orange = orange(rounds, orange_wins)
    raw_gold = gold(rounds, gold_wins)
...
def coin_spread(red_wins, black_wins, purple_wins, green_wins, yellow_wins, white_wins, orange_wins, gold_wins):
    ...
    #   There's probably a much more efficient way to code this part, I would recommend fixing if possible
